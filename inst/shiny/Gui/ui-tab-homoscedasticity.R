fluidRow(
  ...
  column(width = 12,
         ...
         bs4Card(
           ...
           p("The test of homoscedasticity is accepted when", strong("Experimental F value"), "is smaller than corresponding", strong("Critical F value (or F Table value)"),
             "at confidence of", strong("99% (i.e., 1 - p-value). ")),
